...
const Demo = () => {
  ...
  const demoScenarios = [
    ...
    },
    {
      ...
      duration: "3:12",
      transcript:
        "Good morning, this is Dr. Smith's office. I'd be happy to help you schedule an appointment.",
    },
    {
      ...
      duration: "4:05",
      transcript:
        "Hi there! Thanks for your interest in our products. Let me help you find exactly what you need.",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 mb-12 border border-blue-100">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">
              Featured Demo: Restaurant Booking
            </h2>
            <p className="text-gray-600">
              Listen to how our AI handles a typical restaurant reservation call
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-2xl mx-auto">
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              <p className="text-gray-700 italic text-center">
                "Hello, thanks for calling Mario's Italian Kitchen. How can I
                help you today?"
              </p>
            </div>
          </div>
        ...
        <div className="bg-green-50 rounded-2xl p-12 text-center border border-green-200">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Want to experience CallBot AI yourself? Call our demo number and
