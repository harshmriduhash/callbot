...
const Dashboard = () => {
  ...
  const handleUpgrade = () => {
    window.open(
      "https://buy.stripe.com/test_cNi00l7QKgMw1rf6nb0gw01",
      "_blank"
    );
        ...
        <div className="p-6 lg:p-8">
          ...
          <div className="mb-8 lg:ml-0 ml-12">
            ...
            <p className="text-gray-600">
              Manage your AI voice assistant and call integrations.
            </p>
          </div>
          ...
          {isTrialExpired() && (
            <Alert className="mb-6 border-orange-200 bg-orange-50 lg:ml-0 ml-12">
              ...
              <AlertDescription className="text-orange-800 flex items-center justify-between">
                <span>
                  Your 7-day trial has ended. Please upgrade to continue using
                  CallBot AI.
                </span>
                <Button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 lg:ml-0 ml-12">
            ...
            <StatsCard
              title="Avg Duration"
              value={`${Math.floor(
                (callStats?.avgDuration || 0) / 60
              )}:${String((callStats?.avgDuration || 0) % 60).padStart(
                2,
                "0"
              )}`}
              icon={Clock}
                ...
                <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200">
                  <div>
                    ...
                    <p className="text-sm text-green-700">
                      Configured for{" "}
                      {profile?.niche?.replace("-", " ") || "general"} business
                    </p>
                  </div>
                  <Badge
                    variant="secondary"
            ...
            <Card className="hover:shadow-md transition-shadow duration-200">
              ...
              <CardContent className="space-y-3">
                ...
                <Button
                  ...
                  className="w-full justify-start border-gray-200 hover:bg-gray-50"
                  onClick={() =>
                    (window.location.href = "/dashboard/voice-ai-test")
                  }
                >
                  <Phone className="mr-2" size={16} />
                  Test Voice AI
